       ...
       case monthA of
            Just m1 -> 
                case monthB of 
                    Just m2 -> 
                        if yearA == yearB then
                            Just(abs(monthToInt m1 - monthToInt m2))
                        else if yearA < yearB then
            ...
            Nothing ->  
                case monthB of
                    Just m2 -> Nothing
                    Nothing -> Just(abs(yearA - yearB) * 12)
        ...
        case intcmp year1 year2 of
            ...
            EQ ->
                case month1 of
                    Just m1 ->
                        case month2 of
                            Just m2 -> intcmp (monthToInt m1) (monthToInt m2)
                            Nothing -> LT
                    Nothing ->
                        case month2 of
                            Just m2 -> GT
